                    ...
                    <!--      GRADE      -->
                      <ul id="tabs-demo3" class="nav nav-tabs nav-tabs-v3" role="tablist">
                        <li role="presentation" class="">
                          ...
                          ?>
                          <a href="view_items.php?ts_id=<?php echo $checker ?>&&s_year=11" aria-expanded="true" style="padding-right: 30px; font-size: 18px;"><span class="glyphicon glyphicon-user"></span>
                            <?php echo $track ?> 11</a>
                        </li>
                  ...
                  <div class="panel">
                    <div class="panel-body">
                      ...
                      <div role="tabpanel" class="tab-pane fade active in" id="tab1" aria-labelledby="tab1">                        
                        ...
                        $track=$_GET['ts_id'];
                        $year=$_GET['s_year'];
                          $q_studinfo ="SELECT * from student_info WHERE ts_id='$track' AND s_year='$year'";
                          ...
                          <td>
                            ...
                            <a href="sf1_archieved_12.php?lrn=<?php echo $lrns; ?>&&lname=<?php echo $lname; ?>" class="archieved" title="Move to Archieved" data-toggle="tooltip" id="4"><i class="material-icons"  onclick="myFunction()">&#xE149;</i>
                            </a>
