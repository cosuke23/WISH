                    ...
                    <div class="panel-body">
                      ...
                      <div role="tabpanel" class="tab-pane fade active in" id="tab1" aria-labelledby="tab1">                        
                        <div class="row">
                          <div class="col-md-12">
                            <center>
                            <h1 style="color: red;"> Archived Files (Learners)</h1>
                            </center>
                          </div>
                        </div>
                        <?php
                        
                          $q_studinfo ="SELECT * FROM student_archieve";
                          ...
                          <td>
                            <!--   View Button    -->
                            <a href="stud_retrieve.php?lrn=<?php echo $lrns ?>" class="view" title="Retrive Information" data-toggle="tooltip" id="1"><i class="material-icons" onclick="myFunction()">&#xE2C6;</i>
                            </a>

                              <script type="text/javascript">
                              function myFunction()
                              {
                                alert("Attention!!!\n\nLearners Information will be Retrieved");
                              }
                            </script>
                          </td>
                          </tr>
