                ...
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-body">
                      ...
                      <form action="submit_form5a.php" method="POST" > 
                                 <div class="col-md-12">
                                   ...
                                   <div class="col-md-12" >
                                              ...
                                              <select name="full_name" class="info" required>
                                                ...
                                                <?php
                                                  $s_year=$_GET['s_year'];
                                                  $ts_id=$_GET['ts_id'];
                                                   $q_studinfo = "SELECT lrn, CONCAT(last_name ,' ', first_name , ' ', middle_name) AS fullname FROM student_info WHERE ts_id=$ts_id AND s_year=$s_year";
                                              ...
                                              ?>
                                                ...
                                                <input type="text" name="ict" value="ict" class="info" hidden>
                                                <input type="text" name="syear" value="<?php echo $s_year?>" class="info" hidden>
                                                <input type="text" name="subject" placeholder="Back Subject" class="info" required >

                                               <select name="semester" class="info" required>
                                                  <option>Semester Status </option> 
                                                  <option value="Complete">Complete</option>
                                                  <option value="Incomplete">Incomplete</option>
                                                </select>

                                                <select name="year" class="info" required>
                                                  <option>Year End Status </option> 
