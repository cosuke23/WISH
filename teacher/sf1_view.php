                                 ...
                                 <script type="text/javascript">
                                  ...
                                  <div style="float: right;">
                                      <style>
                                        ...
                                        <ul class="breadcrumb">
                                          <li><a href="view_items.php">SHSF-1</a></li>
                                          <li><a href="sf2_view.php">SHSF-2</a></li>
                                          <li><a href="sf3_view.php">SHSF-3</a></li>
                                          <li><a href="sf4_view.php">SHSF-4</a></li>
                                          <li><a href="sf5a_view.php">SHSF-5A</a></li>
                                          <li><a href="sf5b_view.php">SHSF-5B</a></li>
                                          <li><a href="sf6_view.php">SHSF-6</a></li>
                                          <li><a href="sf7_view.php">SHSF-7</a></li>
                                          <li><a href="sf8_view.php">SHSF-8</a></li>
                                          <li><a href="sf10_view.php">SHSF-10</a></li>
                                        </ul>
                                  </div>
                                    <?php
                                      //get student info
                      ...
                      <form action="submit_form1.php" method="POST"></br>
                          ...
                          <div class="col-md-12">
                            ...
                            <div class="col-md-12" >
                              ...
                              <input type="text" value="<?php echo $religion; ?>"name="religion" placeholder="Religion" class="info" readonly style="margin-bottom: 80px;">
                            </div>
                          </div>
        </form>
      </div>
