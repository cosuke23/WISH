                    ...
                    <ul id="tabs-demo3" class="nav nav-tabs nav-tabs-v3" role="tablist">
                      <style type="text/css">
                        ...
                        <div class="wrappers">
                         ...
                         <button class="btn-change"><a href="sf3view_abm.php" style="text-decoration: none; color: white;"><strong>ABM</strong></a></button>
                      ...
                      <div role="tabpanel" class="tab-pane fade active in" id="tab1" aria-labelledby="tab1">                        
                        ...
                        <?php
                          ...
                          <td>
                            ...
                            <!--   Edit Button    -->
                            <a href="sf3_edit.php?lrn=<?php echo $lrns; ?>&&lname=<?php echo $lname; ?>" class="edit" title="Add" data-toggle="tooltip" id="2"><i class="material-icons">&#xE254;</i>
                            </a>
