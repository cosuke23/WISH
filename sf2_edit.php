               ...
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    ...
                    <!--      GRADE      -->
                      <ul id="tabs-demo3" class="nav nav-tabs nav-tabs-v3" role="tablist">
                       <li role="presentation" class="active">
                          <a href="sf2_view.php?ts_id=1&&s_year=11
                        ...
                        <li role="presentation" class="">
                          <a href="sf2_view12.php?ts_id=<?php echo $checker ?>&&s_year=12" aria-expanded="true" style="padding-right: 30px; font-size: 18px;"><span class="glyphicon glyphicon-user"></span> <?php echo $track ?> 12 </a>
                        </li>
                      ...
                      <div role="tabpanel" class="tab-pane fade active in" id="tab1" aria-labelledby="tab1">                        
                        ...
                        <?php
                          ...
                          <td>
                            ...
                            <!--   Edit Button    -->
                            <a href="sf2_edit.php?lrn=<?php echo $lrns; ?>&&lname=<?php echo $lname; ?>" class="edit" title="Edit" data-toggle="tooltip" id="2"><i class="material-icons">&#xE254;</i>
                            </a>
