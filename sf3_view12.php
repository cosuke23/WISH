                    ...
                    <ul id="tabs-demo3" class="nav nav-tabs nav-tabs-v3" role="tablist">
                      <style type="text/css">
                       ...
                       <?php
                            ...
                            {
                          ?>
                          <button class="btn-change"><a href="sf3_view12.php?ts_id=<?php echo $strand_res['ts_id'];?>" style="text-decoration: none; color: white;"><strong><?php echo $strand_res['description'];?></strong></a></button>
                          <?php 
                           }
                          ?>
                    ...
                    <!--      GRADE      -->
                      <ul id="tabs-demo3" class="nav nav-tabs nav-tabs-v3" role="tablist">
                        <li role="presentation" class="">
                          ...
                          ?>
                          <a href="sf3_view.php?ts_id=<?php echo $checker ?>&&s_year=11" aria-expanded="true" style="padding-right: 30px; font-size: 18px;"><span class="glyphicon glyphicon-user"></span> <?php echo $track ?> 11</a>
                        </li>
                         
                        <li role="presentation" class="active">
                          <a href="sf3_view_ict12.php?ts_id=<?php echo $checker ?>&&s_year=12" aria-expanded="true" style="padding-right: 30px; font-size: 18px;"><span class="glyphicon glyphicon-user"></span> <?php echo $track ?> 12 </a>
                        </li>
                    ...
                    <div class="panel-body">
                      ...
                      <div role="tabpanel" class="tab-pane fade active in" id="tab1" aria-labelledby="tab1">                        
                        <div class="row">
                         ...
                         <?php
                          $strand = $_GET['ts_id'];
                          $q_studinfo ="SELECT * from student_info WHERE ts_id='$strand' AND s_year=12";
