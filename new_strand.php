                    ...
                    <ul id="tabs-demo3" class="nav nav-tabs nav-tabs-v3" role="tablist">
                      <style type="text/css">
                       ...
                       <?php
                            ...
                            {
                          ?>
                          <button class="btn-change"><a href="sf1_add.php?ts_id=<?php echo $strand_res['ts_id'];?>" style="text-decoration: none; color: white;"><strong><?php echo $strand_res['description'];?></strong></a></button>
                          <?php 
                           }
                          ?>
                        </div>
                          ...
                          <div class="col-md-12">
                               <!--        ///////     BACK BUTTON     //////// -->
                                 ...
                                 <script type="text/javascript">
                                  ...
                                  <div class="col-md-12">
                                   <h2 style="color: black; text-align: center;">Add New Strand Information</h2>
                                  </div>
                                  <style type="text/css">
                                    .info
                                    {
                                  ...
                                  <div class="col-md-12">
                                     <h3>Strand Information</h3>
                                        <div class="col-md-12" >
                                            <input type="number" name="lrns" placeholder="Description" class="info" required>
                                              <select name="syear" class="info" required>
                                                <option>Choose A Year First</option> 
                                                  <option value="11">11</option>
                                                  <option value="12">12</option>
                                             </select>
                                              <select name="syear" class="info" required>
                                                <option>Choose A Year Second</option> 
                                                  <option value="11">11</option>
                                                  <option value="12">12</option>
                                             </select>
                                        </div></br></br></br>
