                      ...
                      <div role="tabpanel" class="tab-pane fade active in" id="tab1" aria-labelledby="tab1">                        
                        <div class="row">
                          ...
                          <td>
                            ...
                            <a href="sf2_add_attendance.php?ts_id=<?php echo $strand; ?>&&lrn=<?php echo $lrns; ?>&&lname=<?php echo $lname; ?>" class="add" title="Add Attendance" data-toggle="tooltip" id="3"><i class="material-icons">&#xE145;</i>
                            </a>
                          </td>
                          </tr>
