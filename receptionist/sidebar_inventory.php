...
// echo $studname ?>&nbsp;</h5>
                     ...
                     <div class="panel-footer" align="center" style="color: white; background: url('../assets/img/left-bg.png'); margin-top: -72px;"><strong>Receptionist</strong></div>
                </div>
        </div>
  ...
  <div class="nav-side-menu">
                        <label >
                          <a href="home.php"><i class="glyphicon glyphicon-envelope"></i> Messages</a>
                        </label>
                        <br>
                        <label >                           
                          <a href="#.php"><i class="fa fa-tasks"></i> Grades</a>
                        </label><br>                         
